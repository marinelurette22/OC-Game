...
const QUESTIONS = [
  {
    ...
    choix: ['ISO 9001', 'Made in France Premium', 'Origine France Garantie', 'Label Qualité Optique'],
  ...
  },
  {
    ...
    choix: ["L'horlogerie", "L'aéronautique", "L'électronique", 'Les appareils photo et instruments scientifiques'],
  ...
  },
  {
    ...
    choix: ['La netteté visuelle jusqu\'aux bords du verre', 'La résistance aux chocs', 'La légèreté des verres', 'La rapidité de teinte'],
  ...
  },
  {
    ...
    choix: ['Un aigle', 'Une étoile', 'Un Z', 'Un diamant'],
    reponse: 'Un Z',
  },
]
          ...
          return (
            <div key={q.id}>
              ...
              <div style={{
                ...
                {estValide && (
                  <p style={{ fontSize: 13, color: '#111', fontWeight: 700, margin: 0 }}>
                    ✓ {q.reponse}
                  </p>
                )}
              </div>
