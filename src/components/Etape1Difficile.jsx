    ...
    <Layout etape={1}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 15, color: '#333', lineHeight: 1.7 }}>
          Marine cherche une nouvelle paire avec du style et un confort irréprochable.
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 16, color: '#111', lineHeight: 1.7, fontWeight: 600 }}>
          La marque qu'elle a choisie est disponible dans notre magasin.
        </p>
        <p style={{ fontSize: 15, color: '#555', lineHeight: 1.7, marginTop: 12 }}>
          Indice : c'est un <span style={{ color: RED, fontWeight: 700 }}>palindrome</span>.
        </p>
      </div>
